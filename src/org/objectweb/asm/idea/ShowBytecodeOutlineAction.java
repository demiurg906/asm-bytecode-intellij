...
//                asmified.setCode(file, psiFile.getText());
    ...
    @Nullable
    private ClassInsnCollector getMethodsInfo(VirtualFile file, Project project) {
